...
SECRET_KEY = 'zmvivgkfnc)*r*19f3z$_eifolzkl@c*x4ule$9i_=@rld)4q9'
...
EMAIL_HOST_PASSWORD = 'yourpwd' # you have to mention pwd to work correctly
# also have to set less secure apps feture turned in gmail and enable captcha
